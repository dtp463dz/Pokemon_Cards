...
const createPokemonCard = (poke) => {
    ...
    // Thêm sự kiện click để điều hướng sang trang chi tiết Pokémon
    card.addEventListener('click', () => {
        // Chuyển hướng đến trang chi tiết Pokémon với ID
        window.location.href = `details_pokedex.html?id=${poke.id}`;
    });
